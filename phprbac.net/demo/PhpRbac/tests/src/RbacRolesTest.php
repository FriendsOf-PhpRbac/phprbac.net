...
class RbacRolesTest extends \RbacBase {
	...
	/*
	 * // @todo: Need to come back to this one, returns null when it shouldn't public function testRolesPermissionsNotOnlyID() { } //
	 */
	...
	public function testRolesUnassignUsers() {
		...
		$filterDataSet->setExcludeColumnsForTable ( $this->Instance ()->tablePrefix () . 'userroles', array (
				'AssignmentDate' 
		) );
