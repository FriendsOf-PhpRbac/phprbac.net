...
class RbacBase extends \RbacSetup {
	...
	public function testAddSequential() {
		...
		$queryTable = $this->getConnection ()->createQueryTable ( $this->Instance ()->tablePrefix () . $this->type (), 'SELECT * FROM ' . $this->Instance ()->tablePrefix () . $this->type () );
		
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_' . $this->type () . '_sequential.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddHierarchy() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_' . $this->type () . '_hierarchy.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testEditTitle() {
		...
		$queryTable = $this->getConnection ()->createQueryTable ( $this->Instance ()->tablePrefix () . $this->type (), 'SELECT * FROM ' . $this->Instance ()->tablePrefix () . $this->type () . ' WHERE ID=2' );
		
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_edit_' . $this->type () . '_title.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testEditDescription() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_edit_' . $this->type () . '_description.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testEditAll() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_edit_' . $this->type () . '_all.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddPathSingle() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_path_' . $this->type () . '_single.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddPathSingleDescription() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_path_' . $this->type () . '_single_description.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddPathSequential() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_path_' . $this->type () . '_sequential.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddPathSequentialDescription() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_path_' . $this->type () . '_sequential_description.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddPathHierarchy() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_path_' . $this->type () . '_hierarchy.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAddPathHierarchyDescription() {
		...
		$expectedTable = $this->createFlatXmlDataSet ( dirname ( __FILE__ ) . '/datasets/base/expected_add_path_' . $this->type () . '_hierarchy_description.xml' )->getTable ( $this->Instance ()->tablePrefix () . $this->type () );
	...
	public function testAssignWithId() {
		...
		$filterDataSet->setExcludeColumnsForTable ( $this->Instance ()->tablePrefix () . 'rolepermissions', array (
				'AssignmentDate' 
		) );
