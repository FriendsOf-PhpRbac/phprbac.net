...
class RbacManagerTest extends \RbacSetup {
	...
	public function testManagerAssignWithId() {
		...
		$filterDataSet->setExcludeColumnsForTable ( self::$rbac->tablePrefix () . 'rolepermissions', array (
				'AssignmentDate' 
		) );
	...
	public function testManagerReset() {
		...
		$filterDataSet->setExcludeColumnsForTable ( self::$rbac->tablePrefix () . 'userroles', array (
				'AssignmentDate' 
		) );
